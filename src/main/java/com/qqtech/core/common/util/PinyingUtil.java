...
public class PinyingUtil {
	 ...
	 * @return
	 */
	public static String getPinYin(String hanzhi, boolean isHeadChar) {
	...
	public static String hanziToPinyinNoSpace(String hanzi) {
		return hanziToPinyin(hanzi, "");
	}
	...
	public static void main(String[] args) {
		System.out.println(getPinYin("汉子", true));
	}
}